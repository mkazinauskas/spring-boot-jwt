package com.modzo.security.domain.users.commands

import com.modzo.commons.domain.DomainException
...
import static DomainException.userByUniqueIdWasNotFound
